...
test_all: 
	rm -f *.rpt
	@for p in BinarySearch BinaryTree BubbleSort Factorial LinearSearch LinkedList QuickSort test1 test2 test3 test4 test5 test6 test7 test8 test9 test10 test11 test12 test13; do \
