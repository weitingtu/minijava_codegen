...
class Class
{
    ...
    public boolean addVar( String id, Type type )
    {
        ...
        {
            fields.put( id, new Variable( id, type, fields.size() ) );
            return true;
        }
    }
...
class Variable
{
    ...
    public Variable( String id, Type type, int idx )
    {
        this.id = id;
        this.type = type;
        this.idx = idx;
...
class Method
{
    ...
    public boolean addParam( String id, Type type )
    {
        ...
        {
            params.addElement( new Variable( id, type, params.size() ) );
            return true;
        }
    }
    ...
    public boolean addVar( String id, Type type )
    {
        ...
        {
            vars.put( id, new Variable( id, type, vars.size() ) );
            return true;
        }
    }
